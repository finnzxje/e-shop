# E‑Shop API Reference

This document captures the currently exposed HTTP endpoints for the E‑Shop backend. All routes are prefixed with `/api/auth` unless otherwise stated.
